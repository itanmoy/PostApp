...
class PostAppSupabaseUser extends BaseAuthUser {
  PostAppSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> postAppSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = PostAppSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
